package com.sunrui.common.step1;
...
public class CombineDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.setInputPaths(job, new Path("d:\\lagou\\data\\mr\\input")); //指定读取数据的原始路径
        // 7. 指定job输出结果路径
        FileOutputFormat.setOutputPath(job, new Path("d:\\lagou\\data\\mr\\merge-out")); //指定结果数据输出路径
